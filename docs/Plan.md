...
### Сценарий №10 Оплата картой с пустым полем "Номер карты"
...
5.Ввести невалидные данные в поле "CVC"  
6.Нажать кнопку "Продолжить".  
Ожидаемый результат: под полем номер карты красным цветом увидим ошибку : "Неверный формат".  

### Сценарий №11 Оплата картой с пустым полем "Месяц"
...
5.Ввести невалидные данные в поле "CVC"  
6.Нажать кнопку "Продолжить".  
Ожидаемый результат: под полем месяц красным цветом увидим ошибку : "Неверный формат". 

### Сценарий №12 Оплата картой с пустым полем "Год"
1.Ввести валидные данные в поле "Номер карты"  
...
5.Ввести невалидные данные в поле "CVC"  
6.Нажать кнопку "Продолжить".  
Ожидаемый результат: под полем год красным цветом увидим ошибку : "Неверный формат". 

### Сценарий №13 Оплата картой с пустым полем "Владелец"
1.Ввести валидные данные в поле "Номер карты"  
2.Ввести валидные данные в поле "Месяц"  
3.Ввести валидные данные в поле "Год"  
...
5.Ввести невалидные данные в поле "CVC"  
6.Нажать кнопку "Продолжить".  
Ожидаемый результат: под полем владелец красным цветом увидим ошибку : "Поле обязательно для заполнения". 

### Сценарий №14 Оплата картой с пустым полем "CVV"
1.Ввести валидные данные в поле "Номер карты"  
2.Ввести валидные данные в поле "Месяц"  
3.Ввести валидные данные в поле "Год"  
4.Ввести валидные данные в поле "Владелец"  
5.Оставить пустым поле "CVC"  
6.Нажать кнопку "Продолжить".  
Ожидаемый результат: под полем CVV красным цветом увидим ошибку : "Неверный формат". 
